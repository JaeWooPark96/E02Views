...
public class AlertsActivity extends AppCompatActivity {
    ...
    public void button4_clicked(View button) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_single_choice, stringArray);
    ...
    public void button5_clicked(View button) {
        ...
        final String[] stringArray = { "고양이", "강아지", "부엉이" };
        builder.setPositiveButton(stringArray[0], new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int index) {
                ImageView imageView1 = (ImageView) findViewById(R.id.imageView1);
        ...
        builder.setNegativeButton(stringArray[1], new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int index) {
                ImageView imageView1 = (ImageView) findViewById(R.id.imageView1);
        ...
        builder.setNeutralButton(stringArray[2], new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int index) {
                ImageView imageView1 = (ImageView) findViewById(R.id.imageView1);
